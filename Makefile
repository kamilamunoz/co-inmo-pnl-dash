# co-inmo-pnl-dash — comandos comunes
#
# Uso:
#   make install   instala dependencias con uv
#   make raw       corre la query BQ y guarda data/raw_apartment_inmo_co.parquet
#   make refresh   raw + agrega P&L Inmo por (mes, region) y escribe site/data/kpi_pnl.json
#   make serve     abre el sitio en http://localhost:8005/site/
...
serve:
	@echo "Abre http://localhost:8005/site/ en el navegador"
